 ...
 return (
   <a
      ...
      className="relative flex w-full h-full overflow-hidden rounded-banner bg-brand-bannerDark text-white 
        px-4 md:px-5 mx-auto">
       {/* 텍스트 영역 좌측 */}
      <div className="flex flex-col justify-center text-left mx-card my-8 w-full">
        ...
        <div className="relative pt-6 flex flex-row">
          {/* 선물 박스 이미지 */}
          <img
            src={banner.image}
            alt={banner.title}
        ...
        <div className="flex flex-col items-end -mt-10">
          {banner.ctaLabel && (
            ...
            <LongArrowIcon color="white" className="-mt-2 md:-mt-3"/>
          </>
        )}
        </div>
      </div>
