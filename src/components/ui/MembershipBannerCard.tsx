    ...
    >
      ...
      <div className="relative flex flex-shrink-0 w-1/2 items-center justify-start">
        ...
        <img
          src={banner.image}
          alt={banner.title}
          className="relative h-full object-contain pt-4 -translate-x-5" // 왼쪽으로 살짝 이동
        />
        {/* 뱃지 이미지 (for you) */}
        {banner.badgeImage && (
          <img
      ...
      {/* 2. 텍스트 영역 (우측) - flex-1로 남은 공간 채우고 우측 정렬 */}
      <div className="flex flex-col justify-center items-end text-right flex-1 pl-4">
