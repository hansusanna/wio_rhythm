...
export function TasteSummary({ answers }: Props) {
  ...
  return (
    <div className="mb-8 px-10 py-5 md:px-6 md:py-6 text-base bg-neutral-50">
      <div className="mb-4 flex flex-col items-center gap-4 text-gray-700">
        ...
        <div className="flex w-full flex-row items-center">
          ...
          <span className="mr-2 text-gray-600">{typeLabel(answers.type)}</span>
          <img
        ...
        <div className="flex w-full flex-row items-center">
          ...
          <span className="mr-2 text-gray-600">{regionLabel(answers.region)}</span>
      ...
      <div className="space-y-3">
        ...
        <TasteBar label="산 미" levelKey="acidity" answers={answers} />
        <TasteBar label="당 도" levelKey="sweetness" answers={answers} />
      </div>
    </div>
  );
}
