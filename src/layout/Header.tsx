...
export default function Header({ onStartQuiz }: HeaderProps) {
  ...
  const Logo = ({ className = '' }: { className?: string }) => (
    <Link to="/" className={`inline-flex items-baseline gap-1 ${className}`} aria-label="WioRhythm 홈으로 이동">
              ...
              className={({ isActive }) =>
                ...
                ${
                  isActive
                    ...
                    : 'mainText text-white hover:bg-white/10' // 비활성 (어두운 배경)
                }`
              }
              ...
              {({ isActive }) => (
                <span className="relative inline-block">
                  ...
                  {badgeLinks.has(item.link) && (
                    ...
                    <span className={`menuRound absolute -top-0 -right-3 z-10 leading-none text-[10px] ${
      ...
      <aside className="hidden min-[840px]:block z-40 w-[clamp(250px,41vw,590px)]">
        ...
        <div className="p-4 md:p-6 lg:p-0">
          ...
          <div className="mb-8 md:mb-20">
            ...
            <h2 className="text-subtit text-white font-extralight whitespace-normal break-keep leading-normal">
